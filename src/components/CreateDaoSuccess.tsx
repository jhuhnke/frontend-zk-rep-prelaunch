    ...
    return (
        <div className='bg-gradient-radial min-h-screen flex flex-col items-center justify-center pt-20'>
            <div className="bg-gray-100 border-2 border-purple-800 shadow-lg rounded-3xl overflow-hidden p-8 max-w-4xl w-full" style={{ maxWidth: '70%' }}>
                ...
                <h1 className="text-6xl font-bold mb-4 text-center" style={{ color: '#312e81' }}>DAO Created Successfully</h1>
                {imageUrl && (
                    <div className="flex justify-center mb-4">
                        <img src={imageUrl} alt="DAO Image" className='border-2 border-purple-800 rounded-3xl' style={{ height: 200 }} />
                    </div>
                )}
                {txId && (
...
export default CreateDAOSuccess;